          ...
          >
            ...
            >
              ...
              <div className="flex space-x-10">
                <a href="https://www.instagram.com/wongani.ai" target="_blank" rel="noopener noreferrer" className="text-[11px] uppercase tracking-[0.2em] opacity-40 hover:opacity-100 transition-opacity">Instagram</a>
