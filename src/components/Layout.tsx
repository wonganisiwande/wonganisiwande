  ...
  return (
    <div className="min-h-screen selection:bg-brand-ink selection:text-brand-bg relative overflow-x-hidden transition-colors duration-700">
      ...
      <div className="fixed left-8 bottom-10 z-40 hidden lg:flex flex-col space-y-8 opacity-30 hover:opacity-100 transition-opacity duration-500 text-brand-ink">
        <a href="https://www.instagram.com/wonganisiwande/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform"><Instagram size={18} strokeWidth={1.5} /></a>
        <a href="https://www.tiktok.com/@wonganisiwande" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform"><Music2 size={18} strokeWidth={1.5} /></a>
      ...
      <footer className="px-6 md:px-12 py-12 md:py-16 border-t border-brand-ink/5 flex flex-col md:flex-row justify-between items-center gap-10 md:gap-6 text-[10px] uppercase tracking-[0.2em] opacity-30 hover:opacity-100 transition-all duration-700 text-brand-ink">
        ...
        >
          <a href="https://www.instagram.com/wonganisiwande/" target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity flex items-center gap-2">
            {isNearBottom ? <Instagram size={16} strokeWidth={1.2} /> : 'Instagram'}
          </a>
          <a href="https://www.tiktok.com/@wonganisiwande" target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity flex items-center gap-2">
